...
POST /optimize-energy
  ...
  ▼
  LLM interpretation (OpenRouter, deepseek-v4-flash-0731:free, single call)
...
Model/provider: OpenRouter `deepseek/deepseek-v4-flash-0731:free`
(reasoning enabled, pinned to `open-inference/fp8`, no fallbacks) via
